...
public interface CommonConstant {
     ...
     * 项目立项状态：未完成立项
     */
    public static final Integer PROJECT_STATE_0 = 0;
    /**
     * 项目立项状态：项目完成立项
     */
    public static final Integer PROJECT_STATE_1 = 1;
    /**
     * 项目立项状态：项目已完成
     */
//    public static final Integer PROJECT_STATE_2 = 2;

    /**
     * 项目完成状态：项目未完成
     */
    public static final Integer PROJECT_COMPLETE_STATE_0 = 0;
    /**
     * 项目完成状态：项目已完成
     */
    public static final Integer PROJECT_COMPLETE_STATE_1 = 1;

    /**
     * APQP步骤状态：该步骤未完成
     */
    public static final Integer APQP_STATE_0 = 0;
    /**
     * APQP步骤状态：该步骤已完成
     */
    public static final Integer APQP_STATE_1 = 1;

    /**
     * APQP文件上传状态：该文件未上传
     */
    public static final Integer FILE_STATE_0 = 0;
    /**
     * APQP文件上传状态：该文件已上传
     */
    public static final Integer FILE_STATE_1 = 1;
